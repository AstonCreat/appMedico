...
public class MainActivity extends AppCompatActivity {
    ...
    public void PostDelayedMethod(){
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (isOnline()){
                    Intent intent = new Intent(MainActivity.this,LoginMedicoActivity.class);
    ...
    public void DialogAppear(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(MainActivity.this,R.style.MyCustomDialog);
